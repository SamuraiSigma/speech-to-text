...
void STTError::_bind_methods() {
	ClassDB::bind_method(D_METHOD("get_error_string", "error_number"),
	                     &STTError::get_error_string);

	BIND_ENUM_CONSTANT(OK);
	BIND_ENUM_CONSTANT(UNDEF_FILES_ERR);
	BIND_ENUM_CONSTANT(UNDEF_CONFIG_ERR);
	BIND_ENUM_CONSTANT(UNDEF_QUEUE_ERR);
	BIND_ENUM_CONSTANT(USER_DIR_MAKE_ERR);
	BIND_ENUM_CONSTANT(USER_DIR_COPY_ERR);
	BIND_ENUM_CONSTANT(MULTIBYTE_STR_ERR);
	BIND_ENUM_CONSTANT(CONFIG_CREATE_ERR);
	BIND_ENUM_CONSTANT(MEM_ALLOC_ERR);
	BIND_ENUM_CONSTANT(REC_CREATE_ERR);
	BIND_ENUM_CONSTANT(DECODER_CREATE_ERR);
	BIND_ENUM_CONSTANT(REC_START_ERR);
	BIND_ENUM_CONSTANT(REC_STOP_ERR);
	BIND_ENUM_CONSTANT(UTT_START_ERR);
	BIND_ENUM_CONSTANT(UTT_RESTART_ERR);
	BIND_ENUM_CONSTANT(AUDIO_READ_ERR);
}
